...
return array(
  'plural' => function($n) { return (($n==0) ? 0 : ($n==1) ? 1 : ($n==2) ? 2 : ($n%100>=3 && $n%100<=10) ? 3 : ($n%100>=11) ? 4 : 5); },
    ...
    '%d second ago' => array('منذو %d ثانيه', 'Il y a %d ثواني'),
    '%d minute ago' => array('قبل %d دقيقه', 'Il y a %d دقائق'),
    '%d hour ago' => array('قبل %d ساعه', 'قبل %d ساعات'),
    '%d day ago' => array('قبل %d يوم', 'Il y a %d يوم'),
    '%d week ago' => array('قبل %d أسبوع', 'Il y a %d أسابيع'),
